<template>
  <div class="header">
    <hamburger
      ...
      :isActive="sidebar.isOpened"
    ></hamburger>
    <span class="title">简洁软件Core数据管理平台</span>
      ...
      <el-dropdown class="avatar-container right-menu-item" trigger="click">
        ...
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item divided>
            <span @click="handleUpdatePassWord" style="display: block"
              >修改密码</span
            >
          </el-dropdown-item>
          <el-dropdown-item divided>
      ...
      >
        ...
        <el-form-item>
          <el-row>
            ...
            <el-col :span="4">
              <el-button icon="el-icon-back" type="warning" @click="cancel"
                >取消</el-button
              >
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    submitForm() {
      this.$refs.passWordChangeForm.validate((valid) => {
        if (valid) {
          changePassword({ password: this.passWordChangeFormData.newPassWord })
            .then((data) => {
              if (data.data.code == 0) {
                this.dialogFormVisible = false;
                this.$message({
